...
public enum Planet {
  ...
  VENUS(4.869e24, 6.052e6, 12000),
  EARTH(5.976e24, 6.371e6, 12000),
  MARS(6.421e23, 3.39e6, 20000),
  JUPITER(1.9e27, 6.9911e7, 12000),
  SATURN(5.688e26, 5.8232e7, 12000),
  URANUS(8.686e25, 2.5362e7, 12000),
  NEPTUNE(1.024e26, 2.4622e7, 12000),
